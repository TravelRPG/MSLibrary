...
public class MSMessageLib extends MSPlugin {
    ...
    public static MSMessage reformat(String origin, Object... objs) {
        return new MSMessage() {
            ...
            @Override public String uncoloredMessage() { return null; }
            @Override public String coloredMessage() { return null; }
            @Override public void sendMessage(Player... players) { }
            @Override public void sendMessage(ConsoleCommandSender console) { }
            @Override public void sendUnColoredMessage(Player... players) { }
            @Override public void sendUnColoredMessage(ConsoleCommandSender console) { }
            @Override public void reformat(Object obj) { }
        };
    }
