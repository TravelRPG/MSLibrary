...
internal class MSGui12ButtonBuilder: MSGuiButtonBuilderABS {
    ...
    override fun setDisplayName(displayName: String?): MSGui12ButtonBuilder {
        this.display = displayName
        return this
    }

    override fun setLore(lore: List<String>?): MSGui12ButtonBuilder {
    ...
    override fun addLore(line: String): MSGui12ButtonBuilder {
    ...
    override fun removeLore(index: Int): MSGui12ButtonBuilder {
        if (baseItem != null && baseItem!!.hasItemMeta() && baseItem!!.itemMeta.hasLore()) lore =
            baseItem!!.itemMeta.lore
    ...
    override fun addItemFlags(vararg itemFlags: ItemFlag): MSGui12ButtonBuilder {
        if (itemFlags.isNotEmpty()) itemFlags.forEach { baseFlags.add(it) }
        return this
    }

    override fun setGlow(glow: Boolean): MSGui12ButtonBuilder {
        this.glow = glow
        return this
    }

    override fun setAction(action: MSGuiButtonAction): MSGui12ButtonBuilder {
        this.action = action
        return this
    }

    override fun setAmount(amount: Int): MSGui12ButtonBuilder {
        this.amount = amount
        return this
    }

    override fun setAction(ktFunc: (InventoryClickEvent)->Unit): MSGui12ButtonBuilder {
    ...
    override fun setCancellable(cancel: Boolean): MSGui12ButtonBuilder {
        this.cancel = cancel
        return this
    }

    override fun setCleanable(clean: Boolean): MSGui12ButtonBuilder {
