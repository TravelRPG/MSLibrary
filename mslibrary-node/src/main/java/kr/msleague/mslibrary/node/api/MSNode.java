 ...
 */
public interface MSNode extends MSNodeElement {
     ...
     */
    MSNodeElement get(@Nonnull String path);
     ...
     * @return 아이템 엘리먼트. 존재하지 않을 경우 null.
     */
    MSNodeElement get(@Nonnull String path, boolean deep);
     ...
     */
    void set(@Nonnull String path, @Nullable MSNodeElement node);
    ...
    /**
     * 해당 경로에 MSNode를 생성합니다.
     *
     * @param path 경로
     * @return 새로운 노드, 만일 있을 경우 기존 노드
     */
    MSNode createNode(String path);

    /**
     * 해당 경로에 MSNodeArray를 생성합니다.
     *
     * @param path 경로
     * @return 새로운 노드, 만일 있을 경우 기존 노드
     */
    MSNodeArray createArray(String path);
