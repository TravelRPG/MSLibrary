...
public abstract class AbstractPacket {
     ...
     * 단, 내부 콜백은 노드길이 1 (EX, Proxy->Bukkit1 , Bukkit2->Proxy 등)
     * 만 지원함으로, PacketRelay(sendPacketToSpecificServer, broadcastPacket..) 기능을 이용해서 Bukkit1->Bukkit2 등의 노드길이 2 이상의 콜백을 사용할 경우
